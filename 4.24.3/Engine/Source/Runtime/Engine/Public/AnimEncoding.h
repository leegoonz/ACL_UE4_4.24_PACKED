...
ENGINE_API void AnimationFormat_SetInterfaceLinks(CompressedDataType& CompressedData);	// @third party code - ACLPlugin - Expose to plugins
...
extern ENGINE_API const int32 CompressedTranslationStrides[ACF_MAX];	// @third party code - ACLPlugin - Expose to plugins
extern ENGINE_API const int32 CompressedTranslationNum[ACF_MAX];		// @third party code - ACLPlugin - Expose to plugins
extern ENGINE_API const int32 CompressedRotationStrides[ACF_MAX];
extern ENGINE_API const int32 CompressedRotationNum[ACF_MAX];			// @third party code - ACLPlugin - Expose to plugins
extern ENGINE_API const int32 CompressedScaleStrides[ACF_MAX];			// @third party code - ACLPlugin - Expose to plugins
extern ENGINE_API const int32 CompressedScaleNum[ACF_MAX];				// @third party code - ACLPlugin - Expose to plugins
