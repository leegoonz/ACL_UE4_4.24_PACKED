...
enum AnimationKeyFormat
{
	...
	AKF_ACLDefault,				// @third party code - ACLPlugin
	AKF_ACLCustom,				// @third party code - ACLPlugin
	AKF_ACLSafe,				// @third party code - ACLPlugin
	AKF_MAX,
};
...
struct FUECompressedAnimData : public ICompressedAnimData, public FCompressedAnimDataBase<TNonConstArrayViewMaker>
{
	...
	ENGINE_API void Reset();	// @third party code - ACLPlugin - Expose to plugins
