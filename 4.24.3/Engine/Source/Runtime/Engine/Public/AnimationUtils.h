...
public:
	...
	*/
	 ...
	 * @return				None.
	 */
	ENGINE_API static void ComputeCompressionError(const FCompressibleAnimData& CompressibleAnimData, FCompressibleAnimDataResult& CompressedData, AnimationErrorStats& ErrorStats);	// @third party code - ACLPlugin
#endif
	 ...
	 */
	ENGINE_API static FString GetAnimationKeyFormatString(enum AnimationKeyFormat InFormat);	// @third party code - ACLPlugin
