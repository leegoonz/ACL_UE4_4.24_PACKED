...
ENGINE_API uint8 MakeBitForFlag(uint32 Item, uint32 Position);	// @third party code - ACLPlugin
...
protected:
	ENGINE_API virtual void PopulateDDCKey(FArchive& Ar);	// @third party code - ACLPlugin
#endif // WITH_EDITOR
