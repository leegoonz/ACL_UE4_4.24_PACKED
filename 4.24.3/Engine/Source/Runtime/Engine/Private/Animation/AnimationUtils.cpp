...
FString FAnimationUtils::GetAnimationKeyFormatString(AnimationKeyFormat InFormat)
{
	...
	case AKF_ACLDefault:	return FString(TEXT("AKF_ACLDefault"));	// @third party code - ACLPlugin
	case AKF_ACLCustom:		return FString(TEXT("AKF_ACLCustom"));	// @third party code - ACLPlugin
	case AKF_ACLSafe:		return FString(TEXT("AKF_ACLSafe"));	// @third party code - ACLPlugin
	default:
